...
const R$k=(v)=>{if(v==null)return"—";const a=Math.abs(v);const s=v<0?"-":"";if(a>=1e6)return s+"R$ "+fmt(a/1e6).replace(/,00$/,"")+"M";if(a>=1e3)return s+"R$ "+Math.round(a/1e3)+"k";if(a>=500)return s+"R$ 1k";return"0";};
